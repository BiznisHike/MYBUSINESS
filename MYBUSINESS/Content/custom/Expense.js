var productColumns = [{ name: 'Id', minWidth: '100px' }, { name: 'Product', minWidth: '320px' }, { name: 'Sale Price', minWidth: '100px' }, { name: 'Stock', minWidth: '100px' }, { name: 'PerPack', minWidth: '100px' }];
//var products = []; //[['Ciplet', '10', '60'], ['Gaviscon', '85', '12'], ['Surficol', '110', '8']];
var products = new Array();

var customerColumns = [{ name: 'Id', minWidth: '100px' }, { name: 'Name', minWidth: '320px' }, { name: 'Address', minWidth: '350px' }, { name: 'Balance', minWidth: '100px' }];
//var products = []; //[['Ciplet', '10', '60'], ['Gaviscon', '85', '12'], ['Surficol', '110', '8']];
...
$(document).ready(function () {
    ...
    $("#addNewRow").click(function (e) {
        ...
        var row = '<tr>' +
            '<td id="SNo0' + txtSerialNum + '">'+
            '<td><input type="text" class="form-control" autocomplete="off" name="ExpenseDetail[' + txtSerialNum + '].ExpenseName" id="name0' + txtSerialNum + '"></td>' +
            '<td><input type="text"  class="form-control autocomplete="off" classBGcolor" name="ExpenseDetail[' + txtSerialNum + '].Amount" id="salePrice0' + txtSerialNum + '"></td>' +
